    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
          <dt className="truncate text-sm font-medium text-gray-500">{t('activeRentals')}</dt>
        ...
        {/* Total Customers */}
        <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
          <dt className="truncate text-sm font-medium text-gray-500">{t('totalCustomers')}</dt>
          <dd className="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
            {customersCount || 0}
          </dd>
        </div>
        ...
        {/* Inventory Items */}
        <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
          <dt className="truncate text-sm font-medium text-gray-500">{t('availableItems')}</dt>
          <dd className="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
            {inventoryCount || 0}
          </dd>
        </div>
      ...
      {rentalsCount === 0 && customersCount === 0 && inventoryCount === 0 && (
        <div className="rounded-lg bg-purple-50 px-4 py-5 shadow sm:p-6">
          <h3 className="text-lg font-medium text-purple-900">{t('gettingStarted')}</h3>
